...
@admbp.route("/courses/", methods=["GET", "POST"], strict_slashes=False)
def admincourses():
...
@admbp.route("/courses/<course_id>", methods=["GET", "PUT", "DELETE"], strict_slashes=False)
...
@admbp.route("/courses/<course_id>/questions", methods=["GET", "PUT"], strict_slashes=False)
...
@admbp.route("/courses/<course_id>/teachers", methods=["GET", "PUT"], strict_slashes=False)
...
@admbp.route("/courses/<course_id>/students", methods=["GET", "PUT"], strict_slashes=False)
...
@admbp.route("/courses/<course_id>/examinations", methods=["GET", "PUT"], strict_slashes=False)
...
@admbp.route("/courses/<course_id>/classes", methods=["GET", "PUT"], strict_slashes=False)
